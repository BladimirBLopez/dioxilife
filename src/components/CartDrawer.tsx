          ...
          {items.length === 0 ? (
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 w-full text-sm font-semibold text-white bg-[#25D366] rounded-lg py-3 hover:opacity-90 transition-opacity"
              >
